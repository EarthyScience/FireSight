...
export function newVarData(varValues) {
    ...
    const maxVal = flat.reduce((a,b)=>{if (isNaN(a)) return b;if (isNaN(b)) return a;return a> b ? a : b})
    const minVal = flat.reduce((a,b)=>{if (isNaN(a)) return b;if (isNaN(b)) return a;return a> b ? b : a})
